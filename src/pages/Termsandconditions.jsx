    ...
    return (
        <section>
            <div className="disclaimer">
                ...
                <p>Welcome to rkgservice.com!</p>

                <p>These terms and conditions outline the rules and regulations for the use of RKG Service's Website, located at
                    <a href="https://www.rkgservice.com" target="_blank" rel="noreferrer">www.rkgservice.com</a>.
                </p>

                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                    rkgservice.com if you do not agree to take all of the terms and conditions stated on this page.</p>
                ...
                <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and
                    ...
                    Company’s terms and
                    conditions. "The Company", "Ourselves", "We", "Our" and "Us", refers to our Company. "Party", "Parties", or
                ...
                <p>We employ the use of cookies. By accessing rkgservice.com, you agreed to use cookies in agreement with the RKG
                    Service's <Link to="/privacypolicy" target="_blank">Privacy Policy</Link>.</p>
                ...
                <p>Unless otherwise stated, RKG Service and/or its licensors own the intellectual property rights for all material
                    on rkgservice.com. All intellectual property rights are reserved. You may access this from rkgservice.com for
                    your own personal
                    use subjected to restrictions set in these terms and conditions.</p>

                <h2>You must not:</h2>
                <ul>
                    <li>Republish material from rkgservice.com</li>
                    <li>Sell, rent or sub-license material from rkgservice.com</li>
                    <li>Reproduce, duplicate or copy material from rkgservice.com</li>
                    <li>Redistribute content from rkgservice.com</li>
                </ul>

                <p>This Agreement shall begin on the date hereof.</p>

                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
                    areas of the website. RKG Service does not filter, edit, publish or review Comments prior to their presence on
                    the website.
                    Comments do not reflect the views and opinions of RKG Service,its agents and/or affiliates. Comments reflect the
                    views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws,
                    RKG Service shall
                    not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of
                    any use of and/or posting of and/or appearance of the Comments on this website.</p>

                <p>RKG Service reserves the right to monitor all Comments and to remove any Comments which can be considered
                ...
                <p>You hereby grant RKG Service a non-exclusive license to use, reproduce, edit and authorize others to use,
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
                    ...
                    records with us; (c) the
                    benefit to us from the visibility of the hyperlink compensates the absence of RKG Service; and (d) the link is
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
                    you must inform us by sending an e-mail to RKG Service. Please include your name, your organization name,
                ...
                <p>No use of RKG Service's logo or other artwork will be allowed for linking absent a trademark license agreement.
                </p>
                ...
                <p>We shall not be hold responsible for any content that appears on your Website. You agree to protect and defend
                    ...
                    interpreted as libelous,
                    obscene or criminal, or which infringes, otherwise violates, or advocates the infringement or other violation
                    of, any third party rights.</p>

                <h2>Your Privacy</h2>

                <p>Please read <Link to="/privacypolicy" target="_blank">Privacy Policy</Link></p>
                ...
                <p>We reserve the right to request that you remove all links or any particular link to our Website. You approve to
                    ...
                    conditions and it’s
                    linking policy at any time. By continuously linking to our Website, you agree to be bound to and follow these
